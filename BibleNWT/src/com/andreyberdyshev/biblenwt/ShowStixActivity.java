...
public class ShowStixActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.setTitle(CurrBook + " " + CurrChapter + ":" + CurrStix + "-"
				+ LastStix);
	...
	public void onCreateContextMenu(ContextMenu menu, View v,
		...
		case R.id.textViewShowCurrentStix:
			menu.add(0, MENU_SIZE_22, 0,
					getResources().getString(R.string.font_size) + "16");
			menu.add(0, MENU_SIZE_26, 0,
					getResources().getString(R.string.font_size) + "18");
			menu.add(0, MENU_SIZE_30, 0,
					getResources().getString(R.string.font_size) + "20");
			menu.add(0, MENU_SIZE_32, 0,
					getResources().getString(R.string.font_size) + "22");
			menu.add(0, MENU_SIZE_34, 0,
					getResources().getString(R.string.font_size) + "30");
			menu.add(0, MENU_FIND, 0,
					getResources().getString(R.string.menu_find));
	...
	public boolean onContextItemSelected(MenuItem item) {
		...
		case MENU_SIZE_34:
			...
			break;
		case MENU_FIND:
			Toast.makeText(getApplicationContext(), "Find", Toast.LENGTH_SHORT)
					.show();
